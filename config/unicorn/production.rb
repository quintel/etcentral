worker_processes 2
working_directory '/u/apps/et-model.com/current'
...
listen '/u/apps/et-model.com/shared/pids/unicorn.sock', backlog: 64

# File containing the Unicorn process ID.
pid '/u/apps/et-model.com/shared/pids/unicorn.pid'

# Set the path of the log files inside the log folder of the testapp
stderr_path '/u/apps/et-model.com/shared/log/unicorn.log'
...
before_fork do |server, worker|
  ...
  # end the old process...
  old_pid = '/u/apps/et-model.com/shared/pids/unicorn.pid.oldbin'
...
before_exec do |server|
  ENV["BUNDLE_GEMFILE"] = "/u/apps/et-model.com/current/Gemfile"
end
